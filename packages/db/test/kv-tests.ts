import { Tuple } from '../src/codec.ts';
import { MemoryTransaction } from '../src/kv-store/transactions/memory-tx.ts';

export function kvTests(scenario, { test, describe, beforeEach, expect }) {
