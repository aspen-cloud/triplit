...
This also implies that when a blogPost is created, the `authorId` field should be set to the user's unique identifier. This is usually done in the client code when inserting a new blog post.
