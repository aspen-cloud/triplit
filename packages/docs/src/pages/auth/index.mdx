...
If you need to update the token you are using (for example when signing out or signing in a new user), you can call the `updateToken` method on your client.
