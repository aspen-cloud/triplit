---
description: How to use the TriplitClient fetchById method to query an entity by its primary key.
---
...
This is a convenient shorthand for applying a `where('id', '=', id)` filter and extracting the result from the result set.
