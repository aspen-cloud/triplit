...
The `insert` method may also be used to upsert an existing record when used in a schemaless database or in conjuction with [optional attributes](/schemas/types#optional). For example:
