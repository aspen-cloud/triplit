...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab>
    ```bash copy
    npm i @triplit/client @triplit/react @triplit/react-native
    npm i @triplit/cli --save-dev
    ```
  </Tab>
  <Tab>
    ```bash copy
    pnpm add @triplit/client @triplit/react @triplit/react-native
  ...
  <Tab>
    ```bash copy
    yarn add @triplit/client @triplit/react @triplit/react-native
  ...
  <Tab>
    ```bash copy
    bun add @triplit/client @triplit/react @triplit/react-native
...
Triplit's React hooks work just the same in React Native.
