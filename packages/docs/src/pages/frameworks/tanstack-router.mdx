...
- **`Component`**: A React component that renders the data fetched by the `triplitClient`. The component receives a prop named `results`, which contains the results of the query.
