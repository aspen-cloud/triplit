...
As well you may use the `create` command to create a new Triplit project from a template. For example, to create a new Triplit project with a working chat application:
