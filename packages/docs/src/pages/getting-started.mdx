...
So far we've covered how to set up a local database and query it. Triplit provides a powerful sync engine that can be used to sync your data across devices in real-time. You can read more about syncing [here](/sync).
...
For more information on safely updating your schema in a production database, see the [schema management guide](/guides/schema-management).
