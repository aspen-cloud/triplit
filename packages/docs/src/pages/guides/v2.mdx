...
- How to authenticate with Triplit Cloud using the CLI
- How to deploy a project to Triplit Cloud
- How to monitor your deployment with the Triplit dashboard
...
<Callout type="warning" emoji="⚠️">
  This version of Triplit Cloud is incompatible with the previous version. If
  you created a project with the previous version, you will need to create a new
  project and link your local project to it. If you have any questions or need
  help, please reach out to us on [Discord](https://triplit.dev/discord).
</Callout>
...
various `triplit migrate` commands, you can ignore that step. If you update
