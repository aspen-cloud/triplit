...
[Schemas](/database/schemas) can make your life as Triplit developer significantly easier, by providing data validation at runtime, type-hinting, and access to some of Triplit's more advanced features, like relations.
...
<Callout emoji="💡">
  This guide assumes some working knowledge of Triplit
  [schemas](/database/schemas), including the options available to them,
  client-server [syncing](/syncing-data), and the Triplit CLI (`@triplit/cli`)
  installed.
</Callout>
