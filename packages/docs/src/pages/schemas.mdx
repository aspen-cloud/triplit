...
Some drivers like the lanes of the road, while others like off-roading. Triplit supports both.
...
- If you use Typescript, you will not get type checking for your results.
...
The following schema defines a collection called `todos` with four attributes:
...
Passing a schema to the client constructor will override any schema currently stored in your cache. You may also manage your schema with migrations, as explained in the [Migrations](#migrations) section.
...
Creates a collection with attributes.
