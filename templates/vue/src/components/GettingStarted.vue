...
<template>
  <div class="getting-started">
    ...
    <p>
      The <code>schema.ts</code> file defines the <a :href="ROOT + '/docs/schemas'">schema</a> for
      the todos. The <code>triplit.ts</code> file initializes the
    ...
    <h2>Watch it sync</h2>
    <p>
      <a target="_blank" href="http://localhost:5173">Open the app in a new tab</a>. You should see
      the todos you added in the other window.
    </p>
    <h2>Go offline</h2>
    ...
    <p>
      ...
      <a :href="ROOT">Triplit</a>.
    </p>
    <h2>Read more</h2>
    <p>
      Read our <a :href="ROOT + '/docs'">docs</a> to learn more about everything you can do with
      Triplit.
    </p>
  </div>
</template>
